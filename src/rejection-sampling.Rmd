...
input_csv <- "../data/scc/2021-05-20/inputs/scrubbed-episodes.csv"
# All of the periods we have simulated
periods_universe_csv <- "../data/scc/2021-05-20/inputs-period-resampling/generated-candidates.csv"

output_csv <- "../data/scc/2021-05-20/untrended-period-resampling-gte/target-distribution.csv"
age_out_proportions_output_csv <- "../data/scc/2021-05-20/untrended-period-resampling-gte/age-out-proportions.csv"

simulated_output_csv <- "../data/scc/2021-05-20/untrended-period-resampling-gte/simulated-candidates.csv"
projected_output_csv <- "../data/scc/2021-05-20/untrended-period-resampling-gte/projected-candidates.csv"
simulated_age_out_output_csv <- "../data/scc/2021-05-20/untrended-period-resampling-gte/simulated-age-out-candidates.csv"
projected_age_out_output_csv <- "../data/scc/2021-05-20/untrended-period-resampling-gte/projected-age-out-candidates.csv"
...
reject_proportions AS (
  SELECT c.id, t.admission_age, t.duration_group, t.density / c.density AS reject_ratio
  FROM target_distribution t
  INNER JOIN candidate_distribution c
...
ON fp.id = rp.id
AND fp.admission_age = rp.admission_age
