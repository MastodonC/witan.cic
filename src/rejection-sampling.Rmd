...
dbWriteTable(db, "periods", staged, append = TRUE, row.names = FALSE)

# Upload target distribution
staged <- target_distribution[,c("admission_age", "duration_group", "density")]
dbWriteTable(db, "target_distribution", staged, append = TRUE, row.names = FALSE)
```
...
dbWriteTable(db, "noise", noise, append = FALSE, row.names = FALSE)
```
